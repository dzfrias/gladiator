...
var _encounters := [
	WeightedScene.new("res://scenes/modules/encounters/basic.tscn", 0.25),
	WeightedScene.new("res://scenes/modules/encounters/encounter1.tscn", 0.25),
	WeightedScene.new("res://scenes/modules/encounters/encounter2.tscn", 0.25),
